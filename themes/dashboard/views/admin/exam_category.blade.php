    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Buat Category</h4>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="form-group">
                            <label for="">Masukan Catagory Ujian</label>
                            {{ csrf_field()}}
                            <input type="text" required="required" name="name" placeholder="ex : Semester 1 atau lainnya" class="form-control">
                        </div>
                    </div>
                    <div class="col-sm-12">
                        <div class="form-group">
