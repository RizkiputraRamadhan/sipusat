...
Route::get('/documentasi', function () {
    return view('documentasi');
});
...
Route::prefix('admin')->middleware('theme:dashboard')->name('admin.')->group(function(){
        ...
        Route::middleware(['auth:admin'])->group(function(){
            ...
            Route::get('/catagory_sipusat',[AdminController::class,'exam_category']);
            Route::get('/delete_category/{id}',[AdminController::class,'delete_category']);
            Route::get('/edit_category/{id}',[AdminController::class,'edit_category']);
            Route::get('/category_status/{id}',[AdminController::class,'category_status']);
            Route::get('/create_ujian_sipusat',[AdminController::class,'manage_exam']);
            ...
            Route::get('/result_sipusat',[AdminController::class,'manage_students']);
            ...
            Route::get('/data_siswa_sipusat',[AdminController::class,'registered_students']);
